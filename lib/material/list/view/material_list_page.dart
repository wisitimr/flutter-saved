...
import 'package:findigitalservice/material/list/material_list.dart';
...
class MaterialListPage extends StatefulWidget {
  ...
  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (_) => const MaterialListPage());
  }
}
...
class _MaterialListPageState extends State<MaterialListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return PortalMasterLayout(
      body: BlocProvider(
        create: (context) {
          return MaterialBloc(provider)..add(const MaterialStarted());
        },
        child: ListView(
          ...
          children: [
            ...
            Padding(
              ...
              child: BlocListener<MaterialBloc, MaterialXState>(
...
class MaterialCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MaterialBloc, MaterialXState>(builder: (context, state) {
      return Card(
...
class _DataSource extends DataTableSource {
  ...
  final void Function(MaterialModel data) onDetailButtonPressed;
  final void Function(MaterialModel data) onDeleteButtonPressed;
