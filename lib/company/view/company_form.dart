...
import 'package:findigitalservice/company/bloc/company_bloc.dart';
      ...
      listener: (context, state) {
        ...
        if (state.status.isFailure) {
          ...
          final dialog = AwesomeDialog(
            ...
            btnOkOnPress: () {
              context.read<CompanyBloc>().add(const CompanySubmitted());
            },
      ...
      child: BlocBuilder<CompanyBloc, CompanyState>(
        builder: (context, state) {
          switch (state.status) {
            ...
            case CompanyStatus.submited:
              return const CompanyDetail();
            case CompanyStatus.submitConfirmation:
              return const CompanyDetail();
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: (state.isValid
                                    ? () {
                                        context
                                            .read<CompanyBloc>()
                                            .add(const CompanySubmitConfirm());
                                      }
                                    : null),
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
